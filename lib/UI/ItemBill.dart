...
class _ItemBillState extends State<ItemBill> {
  ...
  void initState(){
    ...
    super.initState();
    globals.priceController = TextEditingController();
    globals.stockController = TextEditingController();
    // controllers = List.generate(selectedItems.length, (i) => TextEditingController());

  }

  @override
  void dispose() {
    globals.stockController.dispose();
    globals.priceController.dispose();
    super.dispose();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: SizedBox(
          height: 20.0, child: Text("Add/Edit Items", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15, fontFamily: 'jost', color: Colors.white),),), //<Widget>[]
      ),
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(padding: EdgeInsets.only(left: 20),
              child: Text("Select/Remove Items for Bill", style: TextStyle(
                fontSize: 16,
                        ...
                        Expanded(
                          child: Padding(padding: EdgeInsets.only(left: 40, right: 40),
                            child: SearchableDropdown.multiple(
                              items: items,
                              selectedItems: globals.selectedItems,
                              onChanged: (value) {
                                setState(() {
                                  globals.selectedItems = value;
                                });
                              },
            ...
            // makeInput1(label: "Add Stock Count       "),
            // Padding(
            //   padding: EdgeInsets.all(10),
            // ),
            // makeInput2(label: "Add Price per Count "),
            ...
            //           width: 30,
            //         ),
            //         Text("Add Items", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14, fontFamily: 'jost', color: Colors.black),),
            //
            //       ],
            //     ),
            //   ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed:() {
          Fluttertoast.showToast(
            msg: " Items modified to the Bill Successfully",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.CENTER,
            timeInSecForIosWeb: 2,
            backgroundColor: Color.fromRGBO(0, 0, 38, 1),
  ...
  //                 controller: globals.stockController,
  //                 maxLines: 1,
  ...
  //                 keyboardType: TextInputType.number,
  //                 obscureText: obscureText,
  //                 controller: globals.priceController,
  //                 maxLines: 1,
  //                 decoration: InputDecoration(
  //                   filled: true,
  //                   fillColor: Colors.white,
  ...
  //
  // Widget createTable() {
  //   controllers.length = selectedItems.length*2;
  ...
  //     ),
  //   ]));
  //   for (int i = 0, j=0; i < selectedItems.length; ++i) {
  //     rows.add(
  //         TableRow(children: [
  //           Padding(
  ...
  //             child: Center(child:  Text(tableItems[selectedItems[i]].value.toString(),style: TextStyle(fontFamily: 'jost', fontWeight: FontWeight.w400, fontSize: 14),),),),
  ...
  //     y = 50;
  //     z = x*y;
  //     addProducts(i+1, tableItems[selectedItems[i]].value.toString(), x, y, z, grid );
  //     j = j+2;
  //   }
